...
const Main = forwardRef<HTMLDivElement, Props>(({ offsetTop = false }, ref) => {
  ...
  const mainStyle: CSSProperties = {
    paddingTop: dashboardConfig.HEADER_HEIGHT + (multiTab ? dashboardConfig.MULTI_TABS_HEIGHT : 0),
  ...
  if (themeLayout === ThemeLayout.Horizontal) {
    ...
    mainStyle.width = `calc(100% - ${themeLayout === ThemeLayout.Vertical ? dashboardConfig.NAV_WIDTH : dashboardConfig.NAV_COLLAPSED_WIDTH
      })`;
  } else {
    mainStyle.width = '100vw';
  }
