...
console.log("%c Line:33 🥓 vertexShader", "color:#2eafb0", vertexShader);
...
import { useGameStore, useInteractStore, useLoadedStore } from "@/store/garage";
...
const Sketch3 = () => {
	const cargltf = useGLTF("/garage/models/sm_car.gltf", false, true);
	const startRommgltf = useGLTF(
		"/garage/models/sm_startroom.raw.gltf",
		false,
		true,
	);
	const gltf = useGLTF("/garage/models/sm_speedup.gltf", false, true);
	const aoMap = useTexture("/garage/textures/t_car_body_AO.raw.jpg");
	const lightMap = useTexture("/garage/textures/t_startroom_light.raw.jpg");
	const startRoomAoMap = useTexture("/garage/textures/t_startroom_ao.raw.jpg");
	const floorroughnessMap = useTexture(
		"/garage/textures/t_floor_roughness.webp",
	);
	const floornormalMap = useTexture("/garage/textures/t_floor_normal.webp");
	// const env = useEnvironment({ files: "/garage/textures/t_env_light.hdr" });
