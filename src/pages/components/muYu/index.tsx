  ...
  return (
    <div className="h-full w-full flex items-center justify-center">
      <div className="relative h-96 w-96 flex items-center justify-between p-6 text-[#C39557]">
        {/* 提示文字 */}
        <div
          className={`absolute left-[50%] top-[30%] translate-x-[-50%] text-center text-base opacity-0 ${isStartClick ? 'tips-active' : ''
            }`}
        >
          {tips}
        </div>
        ...
        {/* 木鱼图片按钮 */}
        <div
          className={`relative h-full w-[60%] cursor-pointer bg-contain bg-center bg-no-repeat ${isStartClick ? 'img_click' : ''
            }`}
          style={{
